...
export const sampleAircraft: Aircraft[] = [
  ...
  { id: 'plane-017', type: 'fighter', callsign: 'TFA-006', size: 'small', status: 'assigned', location: 'ground', locationUncertain: true, uncertainLatitude: 31.88, uncertainLongitude: 34.85, protected: 'partial', assignedPositionId: null, assignedDomeId: 'dome-11', suspicionReason: 'חשד לבעיה טכנית - לא מגיב לקריאות', lastStatusUpdate: createDate(3, 8, 30), lastStatusUpdatedBy: updateUsers[3] },
