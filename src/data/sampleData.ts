...
export const sampleDomes: Dome[] = [
  ...
  { id: 'dome-07', shelterId: 'sh-02', name: 'כיפה 3', latitude: 31.9309, longitude: 34.7219, aircraftId: 'plane-016', lastUpdated: createDate(2, 13, 45), updatedBy: updateUsers[4] },
  ...
  { id: 'dome-11', shelterId: 'sh-03', name: 'כיפה 4', latitude: 31.9325, longitude: 34.7241, aircraftId: 'plane-017', lastUpdated: createDate(1, 9, 10), updatedBy: updateUsers[1] },
  ...
  { id: 'dome-15', shelterId: 'sh-05', name: 'כיפה 1', latitude: 31.9287, longitude: 34.7177, aircraftId: 'plane-018', lastUpdated: createDate(0, 8, 0), updatedBy: updateUsers[0] },
...
export const sampleAircraft: Aircraft[] = [
  ...
  { id: 'plane-001', type: 'fighter', callsign: 'TFA-001', size: 'small', status: 'assigned', location: 'ground', protected: 'full', assignedPositionId: null, assignedDomeId: 'dome-01', lastStatusUpdate: createDate(0, 8, 15), lastStatusUpdatedBy: updateUsers[0] },
  { id: 'plane-002', type: 'fighter', callsign: 'TFA-002', size: 'small', status: 'assigned', location: 'air', protected: 'partial', assignedPositionId: null, assignedDomeId: 'dome-02', lastStatusUpdate: createDate(0, 7, 30), lastStatusUpdatedBy: updateUsers[1] },
  // מטוסים שמוקצים לכיפות ריקות - נחשבים באוויר
  { id: 'plane-021', type: 'fighter', callsign: 'TFA-007', size: 'small', status: 'assigned', location: 'ground', protected: 'none', assignedPositionId: null, assignedDomeId: 'dome-03', lastStatusUpdate: createDate(1, 10, 0), lastStatusUpdatedBy: updateUsers[1] }, // כיפה ריקה - נחשב באוויר
  { id: 'plane-022', type: 'fighter', callsign: 'TFA-008', size: 'small', status: 'assigned', location: 'ground', protected: 'partial', assignedPositionId: null, assignedDomeId: 'dome-04', lastStatusUpdate: createDate(2, 14, 30), lastStatusUpdatedBy: updateUsers[2] }, // כיפה ריקה - נחשב באוויר
  // דתק 2 של טייסת 101 (sh-02) - dome-05 עד dome-07 - מטוסי קרב
  { id: 'plane-003', type: 'fighter', callsign: 'TFA-003', size: 'small', status: 'assigned', location: 'ground', protected: 'full', assignedPositionId: null, assignedDomeId: 'dome-05', lastStatusUpdate: createDate(0, 9, 0), lastStatusUpdatedBy: updateUsers[2] },
  { id: 'plane-023', type: 'fighter', callsign: 'TFA-009', size: 'small', status: 'assigned', location: 'ground', protected: 'none', assignedPositionId: null, assignedDomeId: 'dome-06', lastStatusUpdate: createDate(1, 11, 15), lastStatusUpdatedBy: updateUsers[3] }, // כיפה ריקה - נחשב באוויר
  // דתק 1 של טייסת 102 (sh-04) - dome-12 עד dome-14 - מטוסי הפצצה
  { id: 'plane-004', type: 'bomber', callsign: 'TBB-001', size: 'large', status: 'assigned', location: 'air', protected: 'full', assignedPositionId: null, assignedDomeId: 'dome-12', lastStatusUpdate: createDate(0, 6, 45), lastStatusUpdatedBy: updateUsers[3] },
  // דתק 1 של טייסת 201 (sh-06) - dome-19 עד dome-22 - מטוסי תובלה
  { id: 'plane-005', type: 'transport', callsign: 'TTC-001', size: 'large', status: 'assigned', location: 'ground', protected: 'partial', assignedPositionId: null, assignedDomeId: 'dome-19', lastStatusUpdate: createDate(0, 10, 20), lastStatusUpdatedBy: updateUsers[4] },
  { id: 'plane-006', type: 'transport', callsign: 'TTC-002', size: 'large', status: 'assigned', location: 'ground', protected: 'full', assignedPositionId: null, assignedDomeId: 'dome-20', lastStatusUpdate: createDate(0, 10, 25), lastStatusUpdatedBy: updateUsers[4] },
  // דתק 1 של טייסת 202 (sh-09) - dome-30 עד dome-32 - מטוסי סיור
  { id: 'plane-007', type: 'recon', callsign: 'TRD-001', size: 'medium', status: 'assigned', location: 'air', protected: 'none', assignedPositionId: null, assignedDomeId: 'dome-30', lastStatusUpdate: createDate(0, 5, 15), lastStatusUpdatedBy: updateUsers[5] },
  // דתק 1 של טייסת 301 (sh-11) - dome-37 עד dome-39 - מסוקים
  { id: 'plane-008', type: 'helicopter', callsign: 'THE-001', size: 'small', status: 'assigned', location: 'ground', protected: 'full', assignedPositionId: null, assignedDomeId: 'dome-37', lastStatusUpdate: createDate(0, 11, 0), lastStatusUpdatedBy: updateUsers[0] },
  { id: 'plane-009', type: 'helicopter', callsign: 'THE-002', size: 'small', status: 'assigned', location: 'air', protected: 'partial', assignedPositionId: null, assignedDomeId: 'dome-38', lastStatusUpdate: createDate(0, 4, 30), lastStatusUpdatedBy: updateUsers[1] },
  // דתק 1 של טייסת 401 (sh-13) - dome-44 עד dome-46 - מטוסי קרב
  { id: 'plane-010', type: 'fighter', callsign: 'TFA-004', size: 'small', status: 'assigned', location: 'ground', protected: 'full', assignedPositionId: null, assignedDomeId: 'dome-44', lastStatusUpdate: createDate(0, 9, 45), lastStatusUpdatedBy: updateUsers[2] },
  // דתק 1 של טייסת 501 (sh-15) - dome-51 עד dome-54 - מטוסי הפצצה
  { id: 'plane-011', type: 'bomber', callsign: 'TBB-002', size: 'large', status: 'assigned', location: 'air', protected: 'partial', assignedPositionId: null, assignedDomeId: 'dome-51', lastStatusUpdate: createDate(0, 3, 20), lastStatusUpdatedBy: updateUsers[3] },
  { id: 'plane-012', type: 'bomber', callsign: 'TBB-003', size: 'large', status: 'assigned', location: 'ground', protected: 'full', assignedPositionId: null, assignedDomeId: 'dome-52', lastStatusUpdate: createDate(0, 8, 10), lastStatusUpdatedBy: updateUsers[4] },
  // דתק 1 של טייסת 502 (sh-18) - dome-62 עד dome-64 - מסוקים
  { id: 'plane-013', type: 'helicopter', callsign: 'THE-003', size: 'small', status: 'maintenance', location: 'ground', protected: 'none', assignedPositionId: null, assignedDomeId: 'dome-62', lastStatusUpdate: createDate(1, 14, 0), lastStatusUpdatedBy: updateUsers[5] },
  { id: 'plane-014', type: 'helicopter', callsign: 'THE-004', size: 'small', status: 'assigned', location: 'air', protected: 'partial', assignedPositionId: null, assignedDomeId: 'dome-63', lastStatusUpdate: createDate(0, 2, 15), lastStatusUpdatedBy: updateUsers[0] },
  { id: 'plane-015', type: 'helicopter', callsign: 'THE-005', size: 'small', status: 'assigned', location: 'ground', protected: 'full', assignedPositionId: null, assignedDomeId: 'dome-64', lastStatusUpdate: createDate(0, 7, 50), lastStatusUpdatedBy: updateUsers[1] },
  // מטוסים חשודים (מיקום לא מעודכן) - חלק מהם עם כיפות מוקציות
  { id: 'plane-016', type: 'fighter', callsign: 'TFA-005', size: 'small', status: 'assigned', location: 'air', locationUncertain: true, uncertainLatitude: 31.95, uncertainLongitude: 34.75, protected: 'none', assignedPositionId: null, assignedDomeId: 'dome-07', suspicionReason: 'מיקום לא מעודכן - לא התקבל עדכון מיקום במשך יותר מ-24 שעות', lastStatusUpdate: createDate(2, 10, 0), lastStatusUpdatedBy: updateUsers[2] },
  { id: 'plane-017', type: 'fighter', callsign: 'TFA-006', size: 'small', status: 'assigned', location: 'ground', locationUncertain: true, uncertainLatitude: 31.88, uncertainLongitude: 34.85, protected: 'partial', assignedPositionId: null, assignedDomeId: 'dome-11', suspicionReason: 'שגיאת ולידציה - נקלט ממערכת גלקסיה שהמטוס נמצא באוויר', lastStatusUpdate: createDate(3, 8, 30), lastStatusUpdatedBy: updateUsers[3] },
  { id: 'plane-018', type: 'bomber', callsign: 'TBB-004', size: 'large', status: 'assigned', location: 'air', locationUncertain: true, uncertainLatitude: 31.75, uncertainLongitude: 34.70, protected: 'full', assignedPositionId: null, assignedDomeId: 'dome-15', suspicionReason: 'סטייה מנתיב מתוכנן - מיקום לא תואם למשימה', lastStatusUpdate: createDate(1, 15, 45), lastStatusUpdatedBy: updateUsers[4] },
  { id: 'plane-019', type: 'transport', callsign: 'TTC-003', size: 'large', status: 'assigned', location: 'ground', locationUncertain: true, uncertainLatitude: 32.65, uncertainLongitude: 35.15, protected: 'none', assignedPositionId: null, assignedDomeId: null, suspicionReason: 'אובדן קשר - לא ניתן ליצור קשר עם המטוס', lastStatusUpdate: createDate(2, 12, 20), lastStatusUpdatedBy: updateUsers[5] },
  { id: 'plane-020', type: 'recon', callsign: 'TRD-002', size: 'medium', status: 'assigned', location: 'air', locationUncertain: true, uncertainLatitude: 30.70, uncertainLongitude: 34.85, protected: 'partial', assignedPositionId: null, assignedDomeId: null, suspicionReason: 'חשד לבעיה במערכת ניווט - מיקום לא אמין', lastStatusUpdate: createDate(1, 9, 15), lastStatusUpdatedBy: updateUsers[0] },
];
