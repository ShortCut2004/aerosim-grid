...
export const sampleAircraft: Aircraft[] = [
  ...
  { id: 'plane-017', type: 'fighter', callsign: 'TFA-006', size: 'small', status: 'assigned', location: 'ground', locationUncertain: true, uncertainLatitude: 31.88, uncertainLongitude: 34.85, protected: 'partial', assignedPositionId: null, assignedDomeId: 'dome-11', suspicionReason: 'שגיאת ולידציה - נקלט ממערכת לפיד שהמטוס נמצא באוויר', lastStatusUpdate: createDate(3, 8, 30), lastStatusUpdatedBy: updateUsers[3] },
